  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <LocalForm noValidate onSubmit={(values) => handleSubmit(values)}>
  ...
  return (
    <Container>
      <Row className="m-right-6">
        ...
        <Col sm={12} md={5} className="m-1">
          <p>
            Hi, I'm Fabian from México and currently i study the MERN stack, I'm
            in this course using the latest version of react and bootstrap,
            react 17 and bootstrap 5.1, also instead of using reacstrap I'm
            working with react-boostrap so that are the main diferences that
            maybe you'll find in the peer revision, the Versions are:
          </p>
